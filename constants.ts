...
// ⚠️ FIX: Use * as Logo to correctly capture the default or named export of the component
import * as GreenleafLogoModule from '@/assets/GreenleafLogo.tsx';
import * as BstLogoModule from '@/assets/BstLogo.tsx';

// Determine the actual component export name (assuming it's either default or named)
const GreenleafLogoComponent = GreenleafLogoModule.default || (GreenleafLogoModule as any).GreenleafLogo;
const BstLogoComponent = BstLogoModule.default || (BstLogoModule as any).BstLogo;
...
        logo: GreenleafLogoComponent, // ⚠️ Use the correctly extracted component
        palette: {
...
    'BST Expedite': {
        name: 'BST Expedite',
        logo: BstLogoComponent, // ⚠️ Use the correctly extracted component
        palette: {
