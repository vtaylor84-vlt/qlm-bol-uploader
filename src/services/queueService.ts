...
// CORRECTED: Go up one level to src/types
import { QueuedSubmission, LoadSubmission } from '../types'; 
// CORRECTED: Use peer path (./) since both files are in src/services/
import { uploadSubmission } from './uploadService.ts'; 
...
export const processQueue = async (): Promise<void> => {
    ...
    for (const submission of submissions) {
        ...
        try {
            // Use the correctly imported uploadSubmission function
