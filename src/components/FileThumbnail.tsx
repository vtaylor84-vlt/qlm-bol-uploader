// File: src/components/FileThumbnail.tsx

import React from 'react';
import type { UploadedFile } from '../types'; // CORRECTED: Go up to src/types.ts
import { XIcon } from './icons/XIcon.tsx'; // CORRECTED: Go down to ./icons/
import { DocumentIcon } from './icons/DocumentIcon.tsx'; // CORRECTED
import { FileIcon } from './icons/FileIcon.tsx'; // CORRECTED
