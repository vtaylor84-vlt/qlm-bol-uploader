  ...
  return (
    <div className="app-container space-y-6">
      ...
      <div className="bg-[#0a0a0a] border border-zinc-800 rounded-lg p-5 shadow-2xl space-y-6">
        <div className="text-center h-12 flex items-center justify-center border-b border-zinc-800 pb-4 text-zinc-600 italic text-xs">Select a company to view logo</div>
        ...
        <button className="w-full bg-zinc-800 text-zinc-500 font-orbitron py-4 rounded-md uppercase text-xs tracking-widest cursor-not-allowed">Complete Required Fields</button>
      </div>
    </div>
  );
};
