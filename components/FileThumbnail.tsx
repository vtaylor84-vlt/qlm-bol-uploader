...
import type { UploadedFile } from '@/types.ts'; // Fixed import path
import { XIcon } from '@/components/icons/XIcon.tsx'; // Fixed import path
import { DocumentIcon } from '@/components/icons/DocumentIcon.tsx'; // Fixed import path
import { FileIcon } from '@/components/icons/FileIcon.tsx'; // Fixed import path
